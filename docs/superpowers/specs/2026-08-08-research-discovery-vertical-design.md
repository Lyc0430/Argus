...
- explicit variable or concept mappings;
...
- proxy-to-real-setting fidelity and external-validity ceiling;
...
- an exact `premise_version` or premise digest;
...
- each material candidate has a grounded kill or park rationale;
