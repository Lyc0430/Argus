...
Generate structurally different Bets from real application failures, theoretical mechanisms, explicit paper gaps, or landscape disagreements. For every Bet, preserve its problem anchor, theory anchor, variable mapping, dependency claim, observable prediction, no-garnish counterfactual, null explanation, nearest-work search, and unresolved scope limits. An unsuccessful search does not establish novelty.
