...
def build_fast_vertical_decision_prompt(
    ...
    *,
    ...
    return (
        ...
        "Use research_discovery for finding and screening theory-application research directions. "
        "Use math when the requested outcome is a proof or counterexample, research when the "
        "requested outcome is a full empirical paper pipeline, and software when the method is "
        "already selected and the requested outcome is repository implementation. Use software "
        "for that selected-method repository implementation boundary.\n"
