...
def build_fast_vertical_decision_prompt(
    ...
    *,
    ...
    return (
        ...
        "Use math when the requested outcome is a proof or counterexample and research when the "
        "requested outcome is a full empirical paper pipeline. Use software when the method is "
        "already selected and the requested outcome is repository implementation.\n"
